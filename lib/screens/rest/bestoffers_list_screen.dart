...
class Bestofferslist extends StatefulWidget {

  const Bestofferslist({Key? key, this.bestoffers}) : super(key: key);
  final  List<ProductsHotdeal> ?bestoffers;

  @override
  _BestofferslistState createState() => _BestofferslistState();
}

class _BestofferslistState extends State<Bestofferslist> {
  @override
  ...
  _hotDealswidget(){
    return   StaggeredGridView.countBuilder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ProductsHotdeal product = widget.bestoffers![index];
