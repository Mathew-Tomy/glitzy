...
class Premiumlist extends StatefulWidget {
  ...
  const Premiumlist({Key? key, this.premiumProducts}) : super(key: key);
  final List<ProductsHotdeal> ?premiumProducts;

  @override
  _PremiumlistState createState() => _PremiumlistState();
}
...
class _PremiumlistState extends State<Premiumlist> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          ...
          shrinkWrap: true,
          children: [
            BackWidget( title: 'Premium deals'),
            SizedBox(height: 10,),
            _premiumwidget(),
            Footerwidget(),
          ],
  ...
  _premiumwidget(){
    return   StaggeredGridView.countBuilder(
      crossAxisCount: 2,
      itemCount: widget.premiumProducts!.length,
      shrinkWrap: true,
      physics: BouncingScrollPhysics(),
      itemBuilder: (BuildContext context, int index) {
        ProductsHotdeal product = widget.premiumProducts![index];
